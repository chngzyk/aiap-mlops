...
```bash
$ gcloud container clusters get-credentials tekong-exp-cluster --zone asia-southeast1-c --project machine-learning-ops
```
...
$ polyaxon project create --name aiap-mlops-<YOUR_NAME>
```
...
1. Download a service account key to your local machine (or obtain it
   ...
   convention: `aisg-100e-sa@machine-learning-ops.iam.gserviceaccount.com`.
...
=== "Linux/macOS"
    ...
    ```bash
    $ export SA_CLIENT_EMAIL="aisg-100e-sa@machine-learning-ops.iam.gserviceaccount.com"
...
=== "Windows PowerShell"
    ...
    ```powershell
    $ $SA_CLIENT_EMAIL="aisg-100e-sa@machine-learning-ops.iam.gserviceaccount.com"
...
```bash
$ gcloud container images list --repository=asia.gcr.io/machine-learning-ops
```
