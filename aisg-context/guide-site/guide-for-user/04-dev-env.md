...
`docker/aiap-mlops-poly-vscode.Dockerfile` to build a
...
=== "Linux/macOS"
    ...
    $ docker build \
        ...
        -f docker/aiap-mlops-poly-vscode.Dockerfile \
...
`http://localhost:8888/ui/default/aiap-mlops-<YOUR_NAME>/services`
...
=== "Linux/macOS"
    ...
    $ docker build \
        ...
        -f docker/aiap-mlops-poly-jupyter.Dockerfile \
        --platform linux/amd64 .
...
```bash
$ gcloud auth activate-service-account aisg-100e-sa@machine-learning-ops.iam.gserviceaccount.com --key-file=$GOOGLE_APPLICATION_CREDENTIALS
```
