...
`aiap-mlops-proc-data`, the following command can
be used:

```bash
$ gsutil mb -p machine-learning-ops -c STANDARD -l ASIA-SOUTHEAST1 -b on gs://aiap-mlops-proc-data
Creating gs://aiap-mlops-proc-data/...
```
