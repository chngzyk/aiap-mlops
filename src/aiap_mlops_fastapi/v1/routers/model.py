...
PRED_MODEL = ops_fapi.deps.PRED_MODEL


@ROUTER.post("/predict", status_code=fastapi.status.HTTP_200_OK)
def predict_sentiment(movie_reviews_json: ops_fapi.schemas.MovieReviews):
    """Endpoint that returns sentiment classification of movie review
    texts.

    Parameters
    ----------
    movie_reviews_json : ops_fapi.schemas.MovieReviews
...
def get_model_version():
    ...
    dict
        ...
        served.
    """
    return {"data": {"model_uuid": ops_fapi.config.SETTINGS.PRED_MODEL_UUID}}
